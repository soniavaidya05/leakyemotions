...
def agentTransitions(holdObject, action, world, models, i, j, totalRewards, done, input, expBuff = True):
...
def wolfTransitions(holdObject, action, world, models, i, j, wolfEats, done, input, expBuff = True):
