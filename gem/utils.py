...
def visual_field_sprite(
    ...
    for z in range(world.shape[2]):
        ...
        bounds = (location[0] - vision_i, location[0] + vision_i, location[1] - vision_j, location[1] + vision_j)

        image_r = np.zeros(((2 * vision_i + 1) * tile_size[0], (2 * vision_j + 1) * tile_size[1]))
        image_g = np.zeros(((2 * vision_i + 1) * tile_size[0], (2 * vision_j + 1) * tile_size[1]))
        image_b = np.zeros(((2 * vision_i + 1) * tile_size[0], (2 * vision_j + 1) * tile_size[1]))
        image_a = np.zeros(((2 * vision_i + 1) * tile_size[0], (2 * vision_j + 1) * tile_size[1]))
        ...
        for i in range(bounds[0], bounds[1] + 1):
            for j in range(bounds[2], bounds[3] + 1):
                ...
                image_a[image_i * tile_size[0]: (image_i + 1) * tile_size[0], image_j * tile_size[1]: (image_j + 1) * tile_size[1]] = tile_image_array[:, :, 3]
