...
save_models(models, save_dir, "lstm_build_replay_memories_10000u", 0)

models = addTrain_wolf_gem(models, epochs=10000, epsilon=0.65)
save_models(models, save_dir, "lstm_build_replay_memories_20000u", 0)

models = addTrain_wolf_gem(models, epochs=10000, epsilon=0.54)
save_models(models, save_dir, "lstm_build_replay_memories_30000u", 0)

models = addTrain_wolf_gem(models, epochs=10000, epsilon=0.44)
save_models(models, save_dir, "lstm_build_replay_memories_40000u", 0)

models = addTrain_wolf_gem(models, epochs=10000, epsilon=0.2)
save_models(models, save_dir, "lstm_build_replay_memories_50000u", 0)
