...
from examples.attitudes_persons.utils import (
    update_epsilon,
    update_memories,
    find_moveables,
...
from examples.attitudes_persons.iRainbow_clean import iRainbowModel
from examples.attitudes_persons.env import RPG
import matplotlib.pyplot as plt
...
from examples.attitudes_persons.elements import EmptyObject, Wall
