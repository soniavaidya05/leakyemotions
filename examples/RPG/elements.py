...
class Coin():
    ...
    kind = "coin"  # class variable shared by all instances
...
class Food():
    ...
    kind = "food"  # class variable shared by all instances
...
class Bone():
    ...
    kind = "bone"  # class variable shared by all instances
...
class Agent:
    ...
    def __init__(self, model):
        ...
        self.vision = 6  # agents can see three radius around them
    ...
    def init_replay(self, numberMemories, pov_size=6, visual_depth=6): 
        """
