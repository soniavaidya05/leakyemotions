...
run_params = (
    [0.5, 1500, 20, 0.999, "implicit_attitude+EWA", 12000, 2500, 20.0, 20.0],
    [0.5, 1500, 20, 0.999, "tree_rocks", 12000, 2500, 20.0, 20.0],
    [0.5, 1500, 20, 0.999, "None", 12000, 2500, 20.0, 20.0],
    [0.5, 1500, 20, 0.999, "implicit_attitude", 12000, 2500, 20.0, 20.0],
    # [0.5, 4010, 20, 0.999, "implicit_attitude", 12000, 2500, 20.0, 20.0],
    # [0.5, 4010, 20, 0.999, "CMS", 12000, 2500, 20.0, 20.0],
    [0.5, 1500, 20, 0.999, "EWA", 12000, 2500, 20.0, 20.0],
)
