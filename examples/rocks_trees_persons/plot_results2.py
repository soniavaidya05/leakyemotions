...
process_files(file_pattern="predict_rocks1*.txt", smoothing=1)
process_files(file_pattern="predict_rocks1*.txt", smoothing=5)
process_files(file_pattern="predict_rocks1*.txt", smoothing=10)
