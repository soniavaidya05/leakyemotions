...
process_files(file_pattern="predict_rocks3*.txt", smoothing=1)
process_files(file_pattern="predict_rocks3*.txt", smoothing=5)
process_files(file_pattern="predict_rocks3*.txt", smoothing=10)
