...
process_files(file_pattern="faster*.txt", smoothing=1)

process_files(file_pattern="binary_ind1*.txt", smoothing=1)
process_files(file_pattern="binary_ind1*.txt", smoothing=2)
process_files(file_pattern="binary_ind1*.txt", smoothing=3)
process_files(file_pattern="binary_ind1*.txt", smoothing=4)
# process_files(file_pattern="binary_ind2*.txt", smoothing=1)
# process_files(file_pattern="binary_ind3*.txt", smoothing=1)
# process_files(file_pattern="binary_ind4*.txt", smoothing=1)


# process_files(file_pattern="predict_rocks*.txt", smoothing=5)
# process_files(file_pattern="predict_rocks*.txt", smoothing=10)
# process_files(file_pattern="rocks1*.txt", smoothing=5)
# process_files(file_pattern="rocks1*.txt", smoothing=10)
