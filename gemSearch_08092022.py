...
def updateExperiences(world, models): # create the updated end of round experience memories
...
def playGame(models, worldSize = 15, epochs = 200000, epsilon = 1, maxEpochs = 100):
  ...
  for epoch in range(epochs):
    ...
    while(done == 0):
      ...
      useEndExp = True
      if useEndExp == True:
        updateExperiences(world, models)
...
if newModels == 1:
    ...
    models = []
    models.append(modelClassDQN(5,.0001, 1000, 650, 4, 150)) # agent1 model
    models.append(modelClassDQN(5,.0001, 1000, 650, 4, 150))  # agent2 model
